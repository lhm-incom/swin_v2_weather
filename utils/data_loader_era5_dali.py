...
def get_data_loader(params, files_pattern, distributed, train):
    ...
    dataset = types.SimpleNamespace(
        img_shape_x=dataloader.img_shape_x, img_shape_y=dataloader.img_shape_y
    )
...
class DaliDataLoader(object):
    ...
    def __init__(self, params, location, train, seed=333):
        ...
        self.local_seed = self.global_seed + (
            dist.get_rank() if int(os.getenv("WORLD_SIZE", 1)) > 1 else 0
        )
